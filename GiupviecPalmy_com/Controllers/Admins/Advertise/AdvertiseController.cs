...
namespace GiupviecPalmy_com.Controllers.Admins.Advertise
{
    public class AdvertiseController : Controller
    {
        ...
        public ActionResult AdvertiseIndex(string sortOrder, string sortName, int? page, string posstionSearch, string sortPos, string getSortNameClass, string getSortOrderClass)
        {
            ...
            sllPos = CreateSSL("Logo", "Quảng cáo trái", "Ảnh Module Hỗ trợ khách hàng", "Ảnh Slide");
            ...
            PagedList<GiupviecPalmy_com.Models.Advertise> adv = (PagedList<GiupviecPalmy_com.Models.Advertise>)all.ToPagedList(pageNumber, pageSize);
            ...
            else /// Truong hop co tim kiem theo vi tri
            {
                ...
                adv = (PagedList<GiupviecPalmy_com.Models.Advertise>)all.ToPagedList(pageNumber, pageSize);
        ...
        [HttpPost]
        [ValidateInput(false)]
        public ActionResult AdvertiseCreate(FormCollection collection, GiupviecPalmy_com.Models.Advertise advertise)
        {
            if (Request.Cookies["Username"] != null)
            {
                advertise.Name = collection["Name"]; ;
                advertise.Picture = collection["Picture"];
        ...
        [HttpPost]
        [ValidateInput(false)]
        public ActionResult AdvertiseEdit(FormCollection collection, GiupviecPalmy_com.Models.Advertise advertise)
        {
            if (Request.Cookies["Username"] != null)
            {
                advertise.Name = collection["Name"];
                ...
                advertise.Orders = Convert.ToInt32(collection["Orders"]);
                advertise.Active = (collection["Active"] == "false") ? false : true;
                advertise.Description = collection["Description"];
        ...
        public ActionResult AdvertiseDelete(int id, int page, int pagesize)
        {
            if (Request.Cookies["Username"] != null)
            {
                ...
                List<GiupviecPalmy_com.Models.Advertise> adv = db.Advertises.ToList();
        ...
        public ActionResult UpdateDirect(int id, string order, string width, string height, string name, string image)
        {
            ...
            if (advertise != null)
            {
                ...
                else if (width != null)
                {
                    ...
                    result = "Độ rộng ảnh & quảng cáo đã được thay đổi.";
                }
                else if (height != null)
                {
                    advertise.Height = Convert.ToInt32(height);
                    result = "Chiều cao ảnh & quảng cáo đã được thay đổi.";
                }
                else if (name != null)
                {
                    advertise.Name = name;
                    result = "Tên ảnh & quảng cáo đã được thay đổi.";
                }
                else if (image != null)
                {
                    advertise.Picture = image;
                    result = "Ảnh & quảng cáo đã được thay đổi.";
                }
                else
                {
                    advertise.Active = advertise.Active == true ? false : true;
                    result = "Trạng thái ảnh & quảng cáo đã được thay đổi.";
                }
            }
        ...
        public List<SelectListItem> CreateSSL(string v1, string v2, string v3, string v5)
        {
        ...
        public List<SelectListItem> Possition()
        {
            ...
            Possition.Add(new SelectListItem { Value = "1", Text = "Quảng cáo bên trái" });
            Possition.Add(new SelectListItem { Value = "2", Text = "Ảnh Module Hỗ trợ khách hàng" });
            Possition.Add(new SelectListItem { Value = "4", Text = "Ảnh Slide" });
            return Possition;
        }
        #endregion Possition
        #endregion
            ...
            if (Request.Cookies["Username"] != null)
            {
                ...
                foreach (var file in fileImg)
                {
                    ...
                    if (file.ContentLength > 0)
                    {
                        ...
                        {
                            GiupviecPalmy_com.Models.Advertise aImage = new GiupviecPalmy_com.Models.Advertise();
                            ...
                            aImage.Height = 0;
                            //aImage.Position = 0;
                            aImage.Picture = "/Uploads/" + Filename;
        ...
        public ActionResult Search(string searchString, int? page)
        {
            if (Request.Cookies["Username"] != null)
            {
                ...
                PagedList<GiupviecPalmy_com.Models.Advertise> adv1 = (PagedList<GiupviecPalmy_com.Models.Advertise>)db.Advertises.Where(a => a.Name.ToUpper().Contains(searchString.ToUpper())).OrderByDescending(a => a.Name).ToPagedList(pageNumber, pageSize);
