...
namespace GiupviecPalmy_com.Controllers.Admins.Menu
{
    public class MenuController : Controller
    {
        ...
        public ActionResult MenuIndex(int? page)
        {
            ...
            PagedList<GiupviecPalmy_com.Models.Menu> pMenu = (PagedList<GiupviecPalmy_com.Models.Menu>)menu.ToPagedList(pageNumber, pageSize);
        ...
        public ActionResult MenuCreate()
        {
            ...
            //{
            //    listpage.Add(new SelectListItem { Text = "Nhóm dịch vụ - " + StringClass.ShowNameLevel(module[i].Name, module[i].Level), Value = "/nhan-vien/" + module[i].Tag.ToString() });
            //}

            for (int j = 0; j < groupnews.Count; j++)
            {

                listpage.Add(new SelectListItem { Text = "Nhóm tin tức - " + StringClass.ShowNameLevel(groupnews[j].Name, groupnews[j].Level), Value = "/" + groupnews[j].Tag.ToString()});
                //listpage.Add(new SelectListItem { Text = "Nhóm tin tức - " + StringClass.ShowNameLevel(groupnews[j].Name, groupnews[j].Level), Value = "/danh-muc/" + groupnews[j].Tag.ToString() });
            }
        ...
        [HttpPost]
        [ValidateInput(false)]
        public ActionResult MenuCreate(FormCollection collection, GiupviecPalmy_com.Models.Menu page)
        {
            if (Request.Cookies["Username"] != null)
            {
                page.Name = collection["Name"];
                page.Picture = collection["Picture"];
                ...
                page.Tag = GiupviecPalmy_com.Models.StringClass.NameToTag(collection["Name"]);
        ...
        public ActionResult MenuDelete(int id, int page, int pagesize)
        {
            if (Request.Cookies["Username"] != null)
            {
                ...
                List<GiupviecPalmy_com.Models.Menu> adv = db.Menus.ToList();
        ...
        [HttpPost]
        [ValidateInput(false)]
        public ActionResult MenuEdit(FormCollection collection, GiupviecPalmy_com.Models.Menu menu, int id)
        {
            if (Request.Cookies["Username"] != null)
            {
                ...
                menu.Picture = collection["Picture"];
                ...
                menu.Tag = GiupviecPalmy_com.Models.StringClass.NameToTag(collection["Name"]);

                db.sp_Menu_Update(menu.Id, menu.Name, menu.Tag, menu.IdCategory, menu.Content, menu.Detail, menu.Level, menu.Title, menu.Description, menu.Keyword, menu.Target, menu.Link, menu.Ord, menu.Position, menu.Active, menu.Picture);
                //UpdateModel(menu);
        ...
        public ActionResult Search(string searchString, int? page)
        {
            if (Request.Cookies["Username"] != null)
            {
                ...
                PagedList<GiupviecPalmy_com.Models.Menu> menu = (PagedList<GiupviecPalmy_com.Models.Menu>)db.Menus.Where(a => a.Name.ToUpper().Contains(searchString.ToUpper())).OrderByDescending(a => a.Level).ToPagedList(pageNumber, pageSize);
        ...
        public ActionResult MenuIndex_back()
        {
            ...
            if (numOfNews > 0)
            {
                ViewBag.Pager = GiupviecPalmy_com.Models.Phantrang.PhanTrang(pagesize, curpage, numOfNews, url);
            }
            else
            {
                ViewBag.Pager = "";
        ...
        [HttpPost]
        [ValidateInput(false)]
        public ActionResult MenuCreate_back(FormCollection collection, GiupviecPalmy_com.Models.Menu page)
        {
            if (Request.Cookies["Username"] != null)
            {
                page.Name = collection["Name"];
        ...
        [HttpPost]
        [ValidateInput(false)]
        public ActionResult MenuAddSub(FormCollection collection, GiupviecPalmy_com.Models.Menu page, string Level)
        {
            if (Request.Cookies["Username"] != null)
            {
                page.Name = collection["Name"];
        ...
        public static List<DropDownList> ShowLinkDDL()
        {
            ...
            list.Add(new DropDownList { value = "1", text = "Liên kết nhóm tin" });
            list.Add(new DropDownList { value = "2", text = "Liên kết Menu Giới thiệu" });
            list.Add(new DropDownList { value = "3", text = "Liên kết Menu Dịch vụ" });
            list.Add(new DropDownList { value = "4", text = "Liên kết Menu Tuyển dụng" });
            return list;
        }
        #endregion
