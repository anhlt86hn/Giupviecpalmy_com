...
namespace GiupviecPalmy_com.Controllers.Admins.Member
{
    public class MemberController : Controller
    {
        ...
        [HttpPost]
        [ValidateInput(false)]
        public ActionResult MemberCreate(FormCollection collection, GiupviecPalmy_com.Models.Member pc)
        {
        ...
        [HttpPost]
        [ValidateInput(false)]
        public ActionResult MemberEdit(FormCollection collection, GiupviecPalmy_com.Models.Member pc)
        {
            if (Request.Cookies["Username"] != null)
            {
                pc.Name = collection["Name"];
                ...
                per = collection["Permiss"];
                pc.Permiss = int.Parse(per);
                db.sp_Member_Update(pc.Id, pc.Name, pc.Tel, pc.Email, pc.Address, pc.Picture, pc.Username, pc.Password, pc.Permiss);
                db.SaveChanges();
                return RedirectToAction("MemberIndex");
            }
            else
